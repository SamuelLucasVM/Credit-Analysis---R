...
# Use help para descrever, depois traduz
```
...
-   `Credit.Balance`: Variavel resposta de estudo, Qual o balanço médio do cartão de crédito do usuário;
