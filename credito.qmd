...
iv. apresenta correlação linear significante com a variável `Income` (r= 0.464, 0 \< p \< 0.01);

v. apresenta correlação linear significante com a variável `Limit` (r= 0.862, 0 \< p \< 0.01);

vi. apresenta correlação linear significante com a variável `Rating` (r= 0.864, 0 \< p \< 0.01);
